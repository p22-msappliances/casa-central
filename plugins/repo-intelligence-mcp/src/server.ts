  ...
  tools: [
    {
      ...
      description:
        "Full-text search across all repository intelligence documents. Matches against document title, content, and tags.",
      inputSchema: {
        type: "object",
        properties: {
          query: {
    ...
    },
    {
      ...
      description:
        "Get a repository overview: number of intelligence documents, their titles and tags, and the root directory being scanned.",
      inputSchema: {
        type: "object",
        properties: {},
      },
